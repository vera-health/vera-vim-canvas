...
interface PriorAuthWrapperProps {
  children: React.ReactNode;
}

export const PriorAuthWrapper: React.FC<PriorAuthWrapperProps> = ({children}) => {
  ...
  const handleCopyClick = async () => {
    try {
      ...
      console.error("Failed to copy prior authorization content:", error);
    }
  };
